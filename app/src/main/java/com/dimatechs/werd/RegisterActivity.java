...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText Edname,Edphone,Edpassword,Edgroup,Ednum;
    ...
    private void CreateAccount()
    {
        ...
        else
        {
            ...
            ValidatePhoneNumber(name,phone,password,group,num);
    ...
    private void ValidatePhoneNumber(final String name,final String phone,final String password,final String group,final String num)
    {
